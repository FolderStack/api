...
const mockSendAttestationRequest =
    sendAttestationDataRequest as unknown as jest.Mock<
        typeof sendAttestationDataRequest
    >;
...
describe('verifyAttestation', () => {
    ...
    const mockedClientData = 'CHALLENGE???';
    const mockedClientChallenge = '';
    const mockedKeyId = 'Z8XEr0Ga3ndbU5Evfku4BCJu0R+S7avd1LV/EcngYkQ=';

    const request = parseAsn1Structure(mockedAttestation);
